...
export default function ProjectManager({ userRole = "VIEWER" }) {
  ...
  return (
    <main className="mx-auto w-full max-w-5xl flex-1 px-5 py-8 sm:px-8 lg:px-10 lg:py-12">
      ...
      {canManageProjects ? (
        ...
        <p className="mt-8 text-sm text-muted">View-only access. Contact an administrator to create or change projects.</p>
      )}
